<?php
// source: phar:///usr/src/myapp/vendor/phpstan/phpstan/phpstan.phar/conf/config.neon
// source: phar:///usr/src/myapp/vendor/phpstan/phpstan/phpstan.phar/conf/config.level5.neon
// source: /usr/src/myapp/phpstan.neon.dist
// source: array
...
class Container_a2b4418a6f extends _PHPStan_7d8742a37\Nette\DI\Container
{
	protected $tags = [
		...
		'phpstan.broker.methodsClassReflectionExtension' => ['0109' => true],
		...
		'phpstan.typeSpecifier.methodTypeSpecifyingExtension' => ['0281' => true, '0483' => true],
		'phpstan.rules.rule' => [
			'0354' => true,
			'0358' => true,
			'0359' => true,
		...
		'phpstan.phpDoc.typeNodeResolverExtension' => ['0481' => true],
		'phpstan.typeSpecifier.staticMethodTypeSpecifyingExtension' => ['0484' => true],
	];

	protected $types = ['container' => '_PHPStan_7d8742a37\Nette\DI\Container'];
	protected $aliases = [];

	protected $wiring = [
		'_PHPStan_7d8742a37\Nette\DI\Container' => [['container']],
		'PHPStan\Rules\Rule' => [
			[
				'0134',
				'0135',
		...
		'PHPStan\Type\DynamicStaticMethodReturnTypeExtension' => [['0212', '0215', '0217', '0229', '0335', '0341']],
		...
		'PHPStan\Type\MethodTypeSpecifyingExtension' => [['0281', '0483']],
		...
		'PHPStan\Collectors\Collector' => [['0435', '0436', '0438', '0439', '0441', '0442', '0444', '0466', '0467']],
		...
		'PHPStan\PhpDoc\TypeNodeResolverExtension' => [['0481']],
		'PHPStan\PhpDoc\TypeNodeResolverAwareExtension' => [['0481']],
		'PHPStan\PhpDoc\PHPUnit\MockObjectTypeNodeResolverExtension' => [['0481']],
		'PHPStan\Type\PHPUnit\Assert\AssertFunctionTypeSpecifyingExtension' => [['0482']],
		'PHPStan\Type\PHPUnit\Assert\AssertMethodTypeSpecifyingExtension' => [['0483']],
		'PHPStan\Type\StaticMethodTypeSpecifyingExtension' => [['0484']],
		'PHPStan\Type\PHPUnit\Assert\AssertStaticMethodTypeSpecifyingExtension' => [['0484']],
		'PHPStan\Type\PHPUnit\InvocationMockerDynamicReturnTypeExtension' => [['0485']],
		'PHPStan\Type\PHPUnit\MockBuilderDynamicReturnTypeExtension' => [['0486']],
		'PHPStan\Type\PHPUnit\MockObjectDynamicReturnTypeExtension' => [['0487']],
		'PHPStan\Rules\PHPUnit\CoversHelper' => [['0488']],
		'PHPStan\Rules\PHPUnit\AnnotationHelper' => [['0489']],
		'PHPStan\Rules\PHPUnit\DataProviderHelper' => [['0490']],
		'PHPStan\Rules\PHPUnit\DataProviderHelperFactory' => [['0491']],
	];
	...
	{
		return new PHPStan\Php\PhpVersionFactoryFactory(null, ['/usr/src/myapp']);
	}
	...
	public function createService043(): PHPStan\PhpDoc\DefaultStubFilesProvider
	{
		return new PHPStan\PhpDoc\DefaultStubFilesProvider(
			$this->getService('071'),
			[
				'phar:///usr/src/myapp/vendor/phpstan/phpstan/phpstan.phar/stubs/ReflectionAttribute.stub',
				'phar:///usr/src/myapp/vendor/phpstan/phpstan/phpstan.phar/stubs/ReflectionClass.stub',
				'phar:///usr/src/myapp/vendor/phpstan/phpstan/phpstan.phar/stubs/ReflectionClassConstant.stub',
				'phar:///usr/src/myapp/vendor/phpstan/phpstan/phpstan.phar/stubs/ReflectionFunctionAbstract.stub',
				'phar:///usr/src/myapp/vendor/phpstan/phpstan/phpstan.phar/stubs/ReflectionMethod.stub',
				'phar:///usr/src/myapp/vendor/phpstan/phpstan/phpstan.phar/stubs/ReflectionParameter.stub',
				'phar:///usr/src/myapp/vendor/phpstan/phpstan/phpstan.phar/stubs/ReflectionProperty.stub',
				'phar:///usr/src/myapp/vendor/phpstan/phpstan/phpstan.phar/stubs/iterable.stub',
				'phar:///usr/src/myapp/vendor/phpstan/phpstan/phpstan.phar/stubs/ArrayObject.stub',
				'phar:///usr/src/myapp/vendor/phpstan/phpstan/phpstan.phar/stubs/WeakReference.stub',
				'phar:///usr/src/myapp/vendor/phpstan/phpstan/phpstan.phar/stubs/ext-ds.stub',
				'phar:///usr/src/myapp/vendor/phpstan/phpstan/phpstan.phar/stubs/ImagickPixel.stub',
				'phar:///usr/src/myapp/vendor/phpstan/phpstan/phpstan.phar/stubs/PDOStatement.stub',
				'phar:///usr/src/myapp/vendor/phpstan/phpstan/phpstan.phar/stubs/date.stub',
				'phar:///usr/src/myapp/vendor/phpstan/phpstan/phpstan.phar/stubs/ibm_db2.stub',
				'phar:///usr/src/myapp/vendor/phpstan/phpstan/phpstan.phar/stubs/mysqli.stub',
				'phar:///usr/src/myapp/vendor/phpstan/phpstan/phpstan.phar/stubs/zip.stub',
				'phar:///usr/src/myapp/vendor/phpstan/phpstan/phpstan.phar/stubs/dom.stub',
				'phar:///usr/src/myapp/vendor/phpstan/phpstan/phpstan.phar/stubs/spl.stub',
				'phar:///usr/src/myapp/vendor/phpstan/phpstan/phpstan.phar/stubs/SplObjectStorage.stub',
				'phar:///usr/src/myapp/vendor/phpstan/phpstan/phpstan.phar/stubs/Exception.stub',
				'phar:///usr/src/myapp/vendor/phpstan/phpstan/phpstan.phar/stubs/arrayFunctions.stub',
				'phar:///usr/src/myapp/vendor/phpstan/phpstan/phpstan.phar/stubs/core.stub',
				'phar:///usr/src/myapp/vendor/phpstan/phpstan/phpstan.phar/stubs/typeCheckingFunctions.stub',
				'/usr/src/myapp/vendor/phpstan/phpstan-phpunit/stubs/Assert.stub',
				'/usr/src/myapp/vendor/phpstan/phpstan-phpunit/stubs/AssertionFailedError.stub',
				'/usr/src/myapp/vendor/phpstan/phpstan-phpunit/stubs/ExpectationFailedException.stub',
				'/usr/src/myapp/vendor/phpstan/phpstan-phpunit/stubs/InvocationMocker.stub',
				'/usr/src/myapp/vendor/phpstan/phpstan-phpunit/stubs/MockBuilder.stub',
				'/usr/src/myapp/vendor/phpstan/phpstan-phpunit/stubs/MockObject.stub',
				'/usr/src/myapp/vendor/phpstan/phpstan-phpunit/stubs/Stub.stub',
				'/usr/src/myapp/vendor/phpstan/phpstan-phpunit/stubs/TestCase.stub',
			],
			['/usr/src/myapp']
		);
	}
	...
	public function createService058(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_a2b4418a6f $container)
			{
			...
			public function create(): PHPStan\Analyser\ResultCache\ResultCacheManager
			{
				return new PHPStan\Analyser\ResultCache\ResultCacheManager(
					...
					'/usr/src/myapp/var/cache/phpstan/resultCache.php',
					$this->container->getParameter('analysedPaths'),
					['/usr/src/myapp'],
					'5',
					null,
					[
						'phar:///usr/src/myapp/vendor/phpstan/phpstan/phpstan.phar/stubs/runtime/ReflectionUnionType.php',
						'phar:///usr/src/myapp/vendor/phpstan/phpstan/phpstan.phar/stubs/runtime/ReflectionAttribute.php',
						'phar:///usr/src/myapp/vendor/phpstan/phpstan/phpstan.phar/stubs/runtime/Attribute.php',
						'phar:///usr/src/myapp/vendor/phpstan/phpstan/phpstan.phar/stubs/runtime/ReflectionIntersectionType.php',
					],
					[],
					[],
					false
	...
	{
		return new PHPStan\Analyser\ResultCache\ResultCacheClearer('/usr/src/myapp/var/cache/phpstan/resultCache.php');
	}
	...
	public function createService066(): PHPStan\Command\FixerApplication
	{
		return new PHPStan\Command\FixerApplication(
			...
			['/usr/src/myapp'],
			[
				'phar:///usr/src/myapp/vendor/phpstan/phpstan/phpstan.phar/conf/parametersSchema.neon',
				'phar:///usr/src/myapp/vendor/phpstan/phpstan/phpstan.phar/conf/config.level5.neon',
				'phar:///usr/src/myapp/vendor/phpstan/phpstan/phpstan.phar/conf/config.level4.neon',
				'phar:///usr/src/myapp/vendor/phpstan/phpstan/phpstan.phar/conf/config.level3.neon',
				'phar:///usr/src/myapp/vendor/phpstan/phpstan/phpstan.phar/conf/config.level2.neon',
				'phar:///usr/src/myapp/vendor/phpstan/phpstan/phpstan.phar/conf/config.level1.neon',
				'phar:///usr/src/myapp/vendor/phpstan/phpstan/phpstan.phar/conf/config.level0.neon',
				'/usr/src/myapp/phpstan.neon.dist',
				'/usr/src/myapp/vendor/phpstan/phpstan-phpunit/extension.neon',
			],
			null,
			[
				'phar:///usr/src/myapp/vendor/phpstan/phpstan/phpstan.phar/stubs/runtime/ReflectionUnionType.php',
	...
	public function createService073(): PHPStan\DependencyInjection\DerivativeContainerFactory
	{
		return new PHPStan\DependencyInjection\DerivativeContainerFactory(
			'/usr/src/myapp',
			'/usr/src/myapp/var/cache/phpstan',
			[
				'phar:///usr/src/myapp/vendor/phpstan/phpstan/phpstan.phar/conf/config.level5.neon',
				'/usr/src/myapp/phpstan.neon.dist',
			],
	...
	{
		return new PHPStan\File\FileHelper('/usr/src/myapp');
	}
	...
	{
		return new PHPStan\Rules\Keywords\RequireFileExistsRule('/usr/src/myapp');
	}
	...
	public function createService0481(): PHPStan\PhpDoc\PHPUnit\MockObjectTypeNodeResolverExtension
	{
		return new PHPStan\PhpDoc\PHPUnit\MockObjectTypeNodeResolverExtension;
	}


	public function createService0482(): PHPStan\Type\PHPUnit\Assert\AssertFunctionTypeSpecifyingExtension
	{
		return new PHPStan\Type\PHPUnit\Assert\AssertFunctionTypeSpecifyingExtension;
	}


	public function createService0483(): PHPStan\Type\PHPUnit\Assert\AssertMethodTypeSpecifyingExtension
	{
		return new PHPStan\Type\PHPUnit\Assert\AssertMethodTypeSpecifyingExtension;
	}


	public function createService0484(): PHPStan\Type\PHPUnit\Assert\AssertStaticMethodTypeSpecifyingExtension
	{
		return new PHPStan\Type\PHPUnit\Assert\AssertStaticMethodTypeSpecifyingExtension;
	}


	public function createService0485(): PHPStan\Type\PHPUnit\InvocationMockerDynamicReturnTypeExtension
	{
		return new PHPStan\Type\PHPUnit\InvocationMockerDynamicReturnTypeExtension;
	}


	public function createService0486(): PHPStan\Type\PHPUnit\MockBuilderDynamicReturnTypeExtension
	{
		return new PHPStan\Type\PHPUnit\MockBuilderDynamicReturnTypeExtension;
	}


	public function createService0487(): PHPStan\Type\PHPUnit\MockObjectDynamicReturnTypeExtension
	{
		return new PHPStan\Type\PHPUnit\MockObjectDynamicReturnTypeExtension;
	}


	public function createService0488(): PHPStan\Rules\PHPUnit\CoversHelper
	{
		return new PHPStan\Rules\PHPUnit\CoversHelper($this->getService('reflectionProvider'));
	}


	public function createService0489(): PHPStan\Rules\PHPUnit\AnnotationHelper
	{
		return new PHPStan\Rules\PHPUnit\AnnotationHelper;
	}


	public function createService0490(): PHPStan\Rules\PHPUnit\DataProviderHelper
	{
		return $this->getService('0491')->create();
	}


	public function createService0491(): PHPStan\Rules\PHPUnit\DataProviderHelperFactory
	{
	...
	{
		return new PHPStan\Cache\FileCacheStorage('/usr/src/myapp/var/cache/phpstan/cache/PHPStan');
	}


	public function createServiceContainer(): Container_a2b4418a6f
	{
		return $this;
	}
	...
	{
		return new PHPStan\File\ParentDirectoryRelativePathHelper('/usr/src/myapp');
	}
	...
	{
		return new PHPStan\File\SimpleRelativePathHelper('/usr/src/myapp');
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'excludePaths' => null,
			'level' => 5,
			'paths' => ['/usr/src/myapp/src', '/usr/src/myapp/tests'],
			'exceptions' => [
				'implicitThrows' => true,
			...
			'memoryLimitFile' => '/usr/src/myapp/var/cache/phpstan/.memory_limit',
			'tempResultCachePath' => '/usr/src/myapp/var/cache/phpstan/resultCaches',
			'resultCachePath' => '/usr/src/myapp/var/cache/phpstan/resultCache.php',
			...
			'tmpDir' => '/usr/src/myapp/var/cache/phpstan',
			'debugMode' => true,
			'productionMode' => false,
			'tempDir' => '/usr/src/myapp/var/cache/phpstan',
			'rootDir' => '/usr/src/myapp/vendor/phpstan/phpstan',
			'currentWorkingDirectory' => '/usr/src/myapp',
			...
			'composerAutoloaderProjectPaths' => ['/usr/src/myapp'],
